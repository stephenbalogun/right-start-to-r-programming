...
1. R is free, versatile and used in various industries

2. R can ingest several types of data and cross-communicates with several other analytic software

3. Data is not always tidy. You may need to manipulate the data to get it in the right format

2. Set up your working environment, use R project
